...
for ax, (Omega_key, Omega_label) in zip(axes, components):
    ...
    ax.set_ylabel(f"${Omega_label} / (2\\pi)$\n$\\left(\\mathrm{{mHz}}\\right)$")
...
plt.savefig(
    "tex/figures/EH_ALP-annual_modulation-Omega_a.pdf", transparent=False
)
plt.savefig(
    "tex/figures/EH_ALP-annual_modulation-Omega_a.png", transparent=False
)

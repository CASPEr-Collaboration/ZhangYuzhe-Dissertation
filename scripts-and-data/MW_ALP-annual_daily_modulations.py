...
# v_sun = 233 km/s, because it includes the Sun's peculiar velocity and a modern Galactic rotation speed.
...
annual_times = (
    Time("2022-01-01T00:00:00", scale="utc") + time_diff + annual_days * unit.day
)
...
daily_times = (
    Time("2022-01-01T00:00:00", scale="utc") + time_diff + daily_hours * unit.hour
)
...
output_path = "tex/figures/MW_ALP-annual_daily_modulations-test.pdf"

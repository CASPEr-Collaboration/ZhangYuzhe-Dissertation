...
Cosmic Axion Spin Precession Experiment (CASPEr) is a project proposed in 2014\,\cite{CASPErProposal2014} that use nuclear spins to search for ALP-induced spin precession.
The project has several branches, including electric and gradient-based searches, and both low-magnetic-field and high-magnetic-field implementations.

\subsection{The idea}
The central idea is to tune the NMR resonance to a frequency that matches the ALP Compton frequency.
If the two frequencies align, the ALP field applies a torque on the magnetization and induces a coherent transverse magnetization in the sample.

...
MOND was originally proposed to explain flat galaxy rotation curves and can reproduce several galactic-scale regularities with an acceleration scale $a_0 \sim 10^{-10}\,\mathrm{m\,s^{-2}}$\,\cite{Milgrom1983_MOND,Milgrom2017_MONDreview}. 

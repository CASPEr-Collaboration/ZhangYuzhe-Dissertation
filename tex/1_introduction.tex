...
\subsection{Relaxations}\label{sec:intro:NMR:Relax}
...
\subsubsection{$T_1$ relaxation}\label{sec:intro:NMR:Relax:T1}
...
\subsubsection{$T_2^*$ relaxation}\label{sec:intro:NMR:Relax:T2}
...
\subsubsection{Spin echo}\label{sec:intro:NMR:scheme:echo}

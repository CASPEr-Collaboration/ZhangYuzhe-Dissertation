...
The splitting is illustrated in Figure~\ref{fig:Zeeman}.
...
\begin{figure}
    ...
    \caption{Schematic of the spin-echo sequence in the laboratory frame. The $\pi$ pulse reverses dephasing from static field inhomogeneity, producing an echo at time $2\tau$.}

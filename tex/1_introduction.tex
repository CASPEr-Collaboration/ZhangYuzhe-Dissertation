...
MOND was originally proposed to explain flat galaxy rotation curves and can reproduce several galactic-scale regularities with an acceleration scale $a_0 \sim 10^{-10}\,\mathrm{m\,s^{-2}}$\,\cite{Milgrom1983_MOND,Milgrom2017_MONDreview,Banik2022_MONDreview,Zhao2005_MONDglobularClusters}. 
...
The amplitude $a_0$ is fixed by the local dark-matter density through Equation~\eqref{eq:a0_rhoDM} and has dimensions of energy\,\cite{BERGSTROM1998137,Jungman1992SupersymmetricDM,Sofue_Rubin_2001_RotationCurves}.

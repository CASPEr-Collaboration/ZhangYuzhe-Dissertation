...
In comparison to the thermal-equilibrium magnetization of \SI{1e-8}{\ampere/\meter} at \SI{1}{\tesla} and \SI{300}{\kelvin}, the SPN is one order of magnitude less significant.
...
Longitudinal relaxation $T_1$ controls how quickly the magnetization along the bias magnetic field rebuilds, while transverse relaxation determines how quickly coherent precession dephases.

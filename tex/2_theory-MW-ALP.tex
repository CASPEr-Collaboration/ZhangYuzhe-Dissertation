...
\begin{figure}
    ...
    The figure is reproduced from Ref.\,\cite{YGK2026_CavityLumpedSpin}, originally prepared by the author.}
...
In the resonance scheme, CASPEr-Gradient is only sensitive to the component of $\boldsymbol{\nabla}a$ perpendicular to the bias magnetic field $\mathbf{B}_0$.\footnote{This is sometimes defined as the sensitive axis of a haloscope. However, sensitive axis is also defined as the axes perpendicular to the bias magnetic field. Due to the ambiguity in the definition, the term ``senstive axis'' is avoided in this thesis.}
The bias magnetic field is always veritcal with repect to the ground. 

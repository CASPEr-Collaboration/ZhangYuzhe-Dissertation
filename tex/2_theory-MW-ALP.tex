...
\begin{align}
    ...
    \approx \dfrac{1}{\sqrt{2}} g_{\mathrm{aNN}} \sqrt{\hbar c \rho_{DM}}\,v_{\bot}\\
    & = 2 \pi \times \SI{2e-10}{\Hz} \frac{g_{\mathrm{aNN}}}{\SI{1e-9}{\per\GeV}} \left(\dfrac{\rho_{DM}}{\SI{0.4}{\GeV\per\centi\meter^3}}\right)^{1/2}\dfrac{v_{\bot}}{\SI{220}{\km\per\s}}
    \,.
    \label{eq:Omega_a_MW}
\end{align}
...
\begin{align}
    {B}_a = &\frac{\Omega_a}{\gamma} \\
    =& \SI{2e-17}{\tesla} \frac{\gamma}{-2 \pi \times \SI{12}{\MHz\per\tesla}}\\ \nonumber
    & \frac{g_{\mathrm{aNN}}}{\SI{1e-9}{\per\GeV}} \left(\dfrac{\rho_{DM}}{\SI{0.4}{\GeV\per\centi\meter^3}}\right)^{1/2}\dfrac{v_{\bot}}{\SI{220}{\km\per\s}}
    % \Omega_a & = \gamma |\mathbf{B}_a|\\
    % & = \gamma_{\mathrm{proton}}  \times \SI{5e-18}{\tesla}\\
    % & = \gamma_{\mathrm{Xe-129}}\frac{g_{\mathrm{aNN}}}{\SI{1e-9}{\per\GeV}} \times \SI{-1.9e-17}{\tesla}
    % 5.2e-18 T
    %  -1.9e-17 T
    % \mathbf{B}_a(t) = \frac{}{\gamma} = \frac{1}{\gamma} \dfrac{1}{\sqrt{2}} g_{\mathrm{aNN}} \sqrt{\hbar c \rho_{DM}}\,v_{\bot}
    \,.\label{eq:Bpseudo}
\end{align}

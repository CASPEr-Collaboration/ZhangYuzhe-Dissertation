...
Over the 6-hour measurement, the ALP signal power varied between scan steps mainly due to Earth's rotation changes the component of the ALP-field gradient perpendicular to the bias magnetic field. 
...
For the 7 lowest-energy eigenstates of the Earth-bound ALP halo, the expected daily modulation\footnote{As discussed in Section~\ref{sec:theory:earthALP:periodic}, if no mechaism lifts the degeneracy in a, daily modulation would not be observed by measurements. } of the ALP Rabi frequencies is shown in Figure~\ref{fig:EH_ALP-1s_to_5s-daily_modulation-Omega_a}.

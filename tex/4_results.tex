...
Over the six-hour measurement, the ALP signal power varied between scan steps mainly due to Earth's rotation changes the component of the ALP-field gradient perpendicular to the bias magnetic field. 
...
\begin{figure}[htb]
    ...
    The variation in sensitivity between scans reflects the daily modulation of the ALP wind direction relative to the bias magnetic field.

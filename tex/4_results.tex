...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{figures/norm-5_sigma-2_distributions.pdf}
...
\begin{figure}[htb]
    ...
    Reproduced from Ref.\,\cite{Walter2024_LFthermal} with permission.\YZ{a narrow frequency range for a and c? this figure may have to go to a different section}}
...
\begin{figure}[htb]
    ...
    Reproduced from Ref.\,\cite{Walter2024_LFthermal} with permission.}
    \label{fig:ALPlimits}
\end{figure}

...
These results were applied in a proof-of-principle ALP search with the CASPEr-Gradient-LF apparatus (adapted from Ref.\,\cite{Walter2024_LFthermal}), described in Sections~\ref{sec:results:MWALP20221223}--? of Chapter~\ref{chap:results}:

...
\begin{itemize}
    ...
    Each regime has a distinct signal amplitude and optimal dwell time, as summarized in \YZ{add table reference for the four regimes}.
\end{itemize}

These results were applied in a proof-of-principle ALP search with the CASPEr-Gradient-LF apparatus (adapted from Ref.\,\cite{Walter2024_LFthermal}), described in Sections~\ref{sec:results:MWALP20221223}--\ref{sec:results:exclusion} of Chapter~\ref{chap:results}:

...
\begin{equation}
    a(\mathbf{r}, t)
    = a_0\, e^{\,i\left(\mathbf{k}\cdot\mathbf{r} - 2\pi\nu_a t\right)}
...
\begin{equation}
    ...
    \,.\label{eq:lambda_dB}
\end{equation}
For $m_a < \SI{2.5}{\micro\eV}$\YZ{mention CASPEr scan range} and $v_a < \SI{550}{\km\per\s}$\cite{Evans2019_SHMRefined}, this gives $\lambda_{dB} > \SI{1.7}{\km}$\YZ{check the numbers here. add a reference to calculation script}. 

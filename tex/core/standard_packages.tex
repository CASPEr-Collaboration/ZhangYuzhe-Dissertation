...
[
    ...
    expansion = false % Disables font expansion to avoid issues with non-scalable fonts.
]
...
\usepackage{core/braceMnSymbol} % Adjusts overbraces and underbraces such that longer versions are put together seamlessly.
...
% Share the actual upright body font between mathrm and ordinary math digits.
\DeclareSymbolFont{bodyupright}{TU}{\rmdefault}{m}{n}
\SetSymbolFont{bodyupright}{bold}{TU}{\rmdefault}{b}{n}
\DeclareSymbolFontAlphabet{\mathrm}{bodyupright}
% Use the body font's italic face for ordinary Latin math letters.
\DeclareSymbolFont{bodyletters}{TU}{\rmdefault}{m}{it}
\SetSymbolFont{bodyletters}{bold}{TU}{\rmdefault}{b}{it}
\ExplSyntaxOn
\int_step_inline:nnn {48} {57}
  { \Umathcode #1 = 7 \symbodyupright #1 \scan_stop: }
\int_step_inline:nnn {65} {90}
  { \Umathcode #1 = 7 \symbodyletters #1 \scan_stop: }
\int_step_inline:nnn {97} {122}
  { \Umathcode #1 = 7 \symbodyletters #1 \scan_stop: }
\ExplSyntaxOff
\usepackage{url} % Responsible for URL formatting.
% Reserve math families for the body-letter font; bm can use its fallback method.
\newcommand{\bmmax}{0}
\newcommand{\hmmax}{0}
...
\input{core/additional_packages}

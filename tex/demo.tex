...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[height = 2.5 cm]{core/logo_HPI.pdf}\\[1 ex]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[height = 2.5 cm]{core/logo_UP.pdf}\\[1 ex]
...
\begin{wrapfigure}{r}{0.25\textwidth}
    \vspace*{-4 ex}
    \includegraphics[width = 0.25\textwidth]{core/logo_HPI.pdf}

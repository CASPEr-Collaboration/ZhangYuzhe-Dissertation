...
The ALP field is stochastic (Section~\ref{sec:theory:MWALP:stochasticity} and \ref{sec:theory:earthALP:coherence}), so $\xi$ and $M_1$ must be treated statistically; their r.m.s.\ values are derived in \YZ{add section reference for r.m.s. signal derivation}.
...
\subsection{Candidate, exclusion, limit, and sensitivity}

% here should be a paragraph in explaining the results TODO
% move this to the axion section?
Exclusion and sensitivity in the mass-coupling (\YZ{what is mass coupling space? explain in advance}) parameter space are often reported as one of the results of 
% complete: constraint = exclusion but not = sensitivity

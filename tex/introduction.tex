...
The minimum de~Broglie wavelength is $\lambda_{\mathrm{dB}} \sim \SI{7e-5}{\meter}$ for ALPs in the Milky Way ($m_a \leq \SI{10}{\eV/c^2}$)\,\footnote{dB-wavelength.ipnb}. 
For the ALP mass range relevant to this thesis ($m_a \leq \SI{2.5}{\ueV}$), the de~Broglie wavelength $\lambda_{\mathrm{dB}} \geq \SI{270}{\meter}$, much larger than the size of the laboratory.
...
Considering ALP mass relevant to this thesis $m_a \leq \SI{2.5}{\ueV}$ and velocity $v_a \leq v_\mathrm{esc} = \SI{550}{\km/\s}$, the occupation number is $\mathcal{N} \geq \SI{3e27}{}$, much larger than unity\,\footnote{dB-wavelength.ipnb}. 
...
The most relevant non-gravitational couplings for this thesis are the gradient coupling to nucleons.
The nucleon Hamiltonian in the presence of an ALP field background can be written as \cite{GrahamNewobservables}
\begin{equation}

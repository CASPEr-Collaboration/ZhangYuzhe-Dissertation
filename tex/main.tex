...
%    \boldNumberSetsfalse % Use this value if you want variables for number sets (like N or R) to appear in blackboard bold rather than bold.
    ...
    \myTitle{Search for axionlike particle as dark matter candidate with nuclear magnetic resonance}{}
    ...
    \mySubject{Search for axionlike particle as dark matter candidate with nuclear magnetic resonance}

...
\textbf{Time-series sanity check}
...
\textbf{Fourier transform and digital filtering}
...
\textbf{Five-sigma outlier}

% What is a $5-\sigma$ signal? 
% What $$5-\sigma$$ means is that 
...
\textbf{Outlier threshold determination}
...
\textbf{NMR characterization}

The sample and the bias magnetic field are characterized by the following parameters and measurements:
\begin{enumerate}[label=\arabic*.]
    \item Larmor frequency, $T_2^*$, NMR linewidth and lineshape, polarization, and signal power measured by pulsed-NMR. 
...
Candidates Constraints and Outliers
...
\section{MW ALP measurement}\label{sec:results:MWALP20221223}

...
One example of the PSD spectra and NMR characterization from one of the scan steps is shown in Figure~\ref{fig:measurements}. 
The experimental parameters, along with NMR and ALP characteristics are summarized in Table~\ref{tab:MWALP-meas}.

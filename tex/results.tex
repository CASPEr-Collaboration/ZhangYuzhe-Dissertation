...
This chapter presents data-analysis pipeline, candidate evaluation, the measurement, and resulting exclusion limits.
Two CASPEr-Gradient-LF science runs in the year of 2022 are presented and analyzed. 
...
The ALP coherence time at the search frequency is $\tau_a \approx \SI{0.35}{\s}$, obtained from Equation~\eqref{eq:taua_Qa_nua}.
...
\begin{table}[htb]
    ...
    Here SNR indicates the signal-to-noise ratio of the free decay signal after a $\pi/2$ pulse. \YZ{to be updated with real params}}
    \label{tab:MWALPmeas}
    \begin{tabular}{lc}
        \toprule
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.99\linewidth]{figures/20221214_meas_diagram_15px.drawio.pdf}

...
Monte Carlo simulations were performed to determine the threshold for recovering a $5\,\sigma$ ALP signal with \SI{95}{\%} probability. 
% redo MC simulation in time domain by axionbloch?
Fake $5\,\sigma$ ALP signals were injected into simulated noise spectra before the optimal filtering, and the amplitudes of the filtered NPE was recorded. 
Probability distributions of the filtered NPE were obtained from many realizations of the simulated noise and signal, and the outlier threshold $\Theta_\mathrm{RE}$ was determined from the distribution of the filtered NPE in the presence of a $5\,\sigma$ ALP signal. 
% 
...
\subsection{Overview}\label{sec:results:EarthALP20221214:experiment}

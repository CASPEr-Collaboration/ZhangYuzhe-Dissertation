...
In the standard halo model, the Milky Way ALP population is treated as a virialized, approximately thermal ensemble.
In the Galactic rest frame its velocities follow an approximately Maxwell--Boltzmann distribution, truncated near the Galactic escape speed.
...
The phases of the occupied modes are uncorrelated.
